...
namespace Radarsofthouse\Reepay\Block\Adminhtml\Sales\Order\Creditmemo;
    ...
    public function initTotals()
    {
        ...
        if (empty($surchargeFee) || $surchargeFee == 0) {
            if (!$isEnable || !$isReepayPaymentMethod) {
                $this->_helperLogger->addDebug('Creditmemo Adj ReepaySurchargeFee Total Disabled');
                return $this;
            }
        }
        $total = new \Magento\Framework\DataObject(
            [
                ...
                'block_name' => 'reepay_surcharge_fee'
            ]
        );
